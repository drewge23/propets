...
export function getPostTime(createdAt){
    ...
    else if (differentTime >= minute5 && differentTime < minute10) return '5 minute ago'
    else if (differentTime >= minute10 && differentTime < minute15) return '10 minute ago'
    else if (differentTime >= minute15 && differentTime < minute30) return '15 minute ago'
    else if (differentTime >= minute30 && differentTime < hour) return '30 minute ago'
    else if (differentTime >= hour && differentTime < hour2) return '1 hour ago'
    else if (differentTime >= hour2 && differentTime < hour3) return '2 hour ago'
    else if (differentTime >= hour3 && differentTime < hour4) return '3 hour ago'
    else if (differentTime >= hour4 && differentTime < hour5) return '4 hour ago'
    else if (differentTime >= hour5 && differentTime < hour6) return '5 hour ago'
    else if (differentTime >= hour6 && differentTime <= hour7) return '6 hour ago'
